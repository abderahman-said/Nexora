...
export const SOCIAL_ICONS = [
    {
    href: 'https://www.linkedin.com/in/abdelrahman-elsaeiddev',
    label: 'LinkedIn',
  ...
  {
    href: 'mailto:abdorady6500@email.com',
    label: 'Email',
    svg: `
...

  {
    ...
    svg: `
      <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        <path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.8 19.8 0 0 1 3.08 5.18 2 2 0 0 1 5.06 3h3a2 2 0 0 1 2 1.72c.12.9.33 1.77.62 2.6a2 2 0 0 1-.45 2.11L9.1 10.9a16 16 0 0 0 6 6l1.47-1.13a2 2 0 0 1 2.11-.45c.83.29 1.7.5 2.6.62A2 2 0 0 1 22 16.92z"/>
      </svg>
    `
  }
];
