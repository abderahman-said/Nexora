      ...
      {mounted &&
        createPortal(
          <>
            ...
            <div
              onClick={closeMenu}
              className={`fixed inset-0 z-[990] bg-black/40 backdrop-blur-[2px] transition-opacity duration-150 ease-out ${
              ...
              className={`fixed top-0 z-[99999] h-[100dvh] w-[75vw] max-w-[360px] start-0 flex flex-col overscroll-none
                ...
                overflow-hidden transition-all duration-150 ease-out ${
                  isOpen
                    ...
                    : "-translate-x-full rtl:translate-x-full opacity-0 pointer-events-none"
                }`}
            >
              {/* Top accent bar */}
