...
export function FooterAnimatedShell({ columns, sidePanel, bottomBar }) {
    ...
    return (
        <footer
            ...
            ref={footerRef}
            dir="ltr"
            className="relative w-full  bg-[#0e0e11] text-white font-sans border-t border-white/10"
        >
            ...
            <Button
                ...
                title="Back to Top"
                variant="ghost"
                className="absolute top-0 left-1/2 -translate-x-1/2 -mt-5 z-20 group flex h-10 w-10 p-0 items-center justify-center rounded-full border border-white/20 bg-[#0e0e11] text-slate-300 transition-all duration-300 hover:scale-110 hover:border-blue-400 hover:text-white hover:shadow-[0_0_20px_rgba(59,130,246,0.5)] cursor-pointer"
            >
