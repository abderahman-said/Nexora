                ...
                {navItems.map((item) => (
                    <li key={item.label}>
                        ...
                        >
                            ...
                            <ChevronRight className="h-3.5 w-3.5 rtl:scale-x-[-1] text-slate-400 dark:text-slate-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 group-hover:translate-x-1 rtl:group-hover:-translate-x-1 transition-all duration-200" />
                        </Link>
                    </li>
                ))}
            </ul>
