...
export default function TransitionScribble() {
    useEffect(() => {
        ...
        const runScribbleAnimation = (e: Event) => {
            ...
            let transitionLogo = document.querySelector('.js-transition-logo') as HTMLDivElement | null;
            if (!transitionLogo) {
                ...
                const svgClone = document.querySelector('.js-logo-truus')?.cloneNode(true) as HTMLElement | null;
                if (svgClone) {
