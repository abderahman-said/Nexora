...
import { ANIMATION_CONFIG } from '@/lib/data';
    ...
    useEffect(() => {
        ...
        const transitionScribblePath = document.querySelector('.js-transition-scribble-path');
        const transitionScribbleSvg = document.querySelector('.js-transition-scribble');
        ...
        const runScribbleAnimation = (e) => {
            ...
            let transitionLogo = document.querySelector('.js-transition-logo');
            if (!transitionLogo) {
                transitionLogo = document.createElement('div');
                transitionLogo.className = 'js-transition-logo';
                ...
                const svgClone = document.querySelector('.js-logo-truus').cloneNode(true);
    ...
    return (
        ...
        >
            <path
                className="js-transition-scribble-path"
