                            ...
                            >
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <h3 className="w-fit text-lg font-extrabold text-slate-900 dark:text-white tracking-tight" dir={item.id === 2 ? "ltr" : undefined}>
                                            {item.value}
                                        </h3>
                                ...
                                {item.action && (
                                    ...
                                    >
                                        ...
                                        <ArrowUpRight className="w-4 h-4 rtl:scale-x-[-1]  transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                                    </Link>
                                )}
                            </div>
                        );
