    ...
    return (
        <div ref={visualRef} className="relative w-full max-w-[560px] mx-auto lg:mx-0">
            ...
            <div className="relative z-10 w-full aspect-[4/3.2] sm:aspect-[4/3] rounded-3xl overflow-hidden border border-slate-200/80 dark:border-slate-800 shadow-2xl shadow-slate-900/10 dark:shadow-blue-950/40 group">
                ...
                <div className="absolute top-3 end-3 sm:top-6 sm:end-6 z-20 flex items-center gap-2 sm:gap-2.5 px-3 py-2 sm:px-4 sm:py-2.5 rounded-2xl bg-white/85 dark:bg-slate-900/85 backdrop-blur-md border border-white/50 dark:border-slate-700/60 shadow-xl">
                    ...
                    <div>
                        <div className="text-[0.7rem] sm:text-xs font-extrabold text-slate-900 dark:text-white">{t('visual_years')}</div>
                        <div className="text-[0.6rem] sm:text-[0.65rem] text-slate-500 dark:text-slate-400 font-medium">{t('visual_excellence')}</div>
                    </div>
                </div>

                {/* Floating Glassmorphic Stat Chip Bottom-Left */}
                <div className="absolute bottom-3 start-3 sm:bottom-6 sm:start-6 z-20 flex items-center gap-2.5 sm:gap-3 px-3 py-2 sm:px-4 sm:py-3 rounded-2xl bg-slate-900/90 dark:bg-slate-950/90 text-white backdrop-blur-md border border-slate-800 shadow-2xl">
                    ...
                    <div>
                        <div className="text-xs sm:text-sm font-black text-white tracking-tight">{t('visual_uptime')}</div>
