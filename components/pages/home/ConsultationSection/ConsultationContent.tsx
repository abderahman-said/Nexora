...
export default function ConsultationContent() {
    return (
        <div className="lg:col-span-7 relative z-10 flex flex-col justify-center space-y-5 sm:space-y-6">
            ...
            {/* Main Section Title */}
            <h2 suppressHydrationWarning className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-[1.18]">
            ...
            <p suppressHydrationWarning className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed max-w-2xl font-normal">
                Ready to scale your technology infrastructure and elevate your digital product experience? Schedule a 1-on-1 strategy call with our expert team to explore tailored technical solutions.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80">
                    ...
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200">Free Tech Audit</span>
                </div>

                <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80">
                    <ShieldCheck className="w-4 h-4 text-blue-600 dark:text-sky-400 shrink-0" />
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200">NDA Protected</span>
                </div>

                <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80">
                    <Clock className="w-4 h-4 text-blue-600 dark:text-sky-400 shrink-0" />
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200">Fast Turnaround</span>
                </div>
            </div>
