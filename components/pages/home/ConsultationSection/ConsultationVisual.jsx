            ...
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden aspect-[4/3] lg:aspect-[5/6] border border-slate-200 dark:border-slate-800 bg-slate-950 shadow-xl">
                ...
                ">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-xs font-extrabold text-white leading-none">Live Consultation Active</p>
                            <p className="text-[0.65rem] text-slate-400 mt-0.5">Average response time &lt; 15 mins</p>
                        </div>
                    </div>
