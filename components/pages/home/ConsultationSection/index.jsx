        ...
        >
            <Container className="relative z-10">
                ...
                ">
                    ...
                    <div aria-hidden="true" className="absolute top-0 right-0 w-96 h-96 bg-blue-600/10 dark:bg-sky-500/10 blur-3xl rounded-full pointer-events-none" />
                    <div aria-hidden="true" className="absolute bottom-0 left-0 w-96 h-96 bg-indigo-600/10 dark:bg-blue-500/10 blur-3xl rounded-full pointer-events-none" />
