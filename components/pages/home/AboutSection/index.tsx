        ...
        <Container className="relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-5">
              ...
              <Link
                href={`/${locale}/about`}
                className=" w-fit inline-flex whitespace-nowrap items-center gap-2  text-xs sm:text-sm lg:text-base font-semibold uppercase tracking-wider text-blue-600 dark:text-blue-400 transition-all hover:text-blue-700 dark:hover:text-blue-300 hover:-translate-y-0.5 group"
              >
