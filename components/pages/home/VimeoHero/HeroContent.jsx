...
export default function HeroContent({ headRef, subRef, statsRef, ctaRef, badgeRef }) {
    return (
        <div className="relative z-10 flex flex-col items-center">
            ...
            <p
                ...
                className="
                    ...
                    max-w-[540px] leading-[1.65] mb-8 font-semibold drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)] dark:drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]
                "
            >
