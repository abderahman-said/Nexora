  ...
  return (
    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center py-2 lg:py-8">
      ...
      <div className="lg:col-span-6 order-1 lg:order-1 flex flex-col items-start text-left">
        ...
        >
          We transform your ideas into integrated digital solutions that make a real difference and support your business growth. Delivering smart, high-performance applications designed to innovate, evolve, and scale efficiently.
        </p>

        {/* Action Buttons (Primary CTA + WhatsApp Button with Equal Heights) */}
        <div
          ref={ctaRef}
          className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-6 w-full"
        >
          {/* Primary Button */}
          <Magnet padding={30} magnetStrength={25}>
            <Link
              ...
              className="
                ...
                h-[54px] sm:h-[60px] px-8 rounded-full bg-gradient-to-r from-blue-600 to-sky-600 text-white
          ...
          <Magnet padding={30} magnetStrength={25}>
            <Link
              ...
              className="
                group inline-flex items-center justify-center gap-3.5 h-[54px] sm:h-[60px] px-5 sm:px-6 rounded-full
      ...
      <div ref={imageRef} className="lg:col-span-6 order-2 lg:order-2 relative w-full flex items-center justify-center mt-4 lg:mt-0">
        ...
        <div className="relative w-full max-w-[580px] group">
          ...
          <div className="relative rounded-[28px] border border-slate-200/90 dark:border-slate-800/90 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-3 sm:p-5 shadow-2xl shadow-blue-500/10 dark:shadow-black/60 transition-all duration-500 hover:border-blue-500/40">
            ...
            <div className="relative w-full overflow-hidden rounded-[20px] bg-slate-50 dark:bg-slate-950/50 p-2 sm:p-4 flex items-center justify-center">
              ...
              {/* Code / Status Chip on Image */}
              <div className="absolute top-4 left-4 flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-950/80 backdrop-blur-md border border-white/20 text-white text-[0.72rem] font-mono tracking-tight shadow-md">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <span>Nexora.init()</span>
              </div>
            </div>
            ...
            <div className="absolute top-6 -right-2 sm:-right-4 hidden sm:flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-white/95 dark:bg-slate-900/95 border border-slate-200/90 dark:border-slate-800/90 shadow-xl shadow-black/10 backdrop-blur-xl animate-float-y">
              ...
              <div>
                <p className="text-[0.75rem] font-bold text-slate-900 dark:text-white leading-tight">Smart Solutions</p>
                <p className="text-[0.65rem] text-slate-500 dark:text-slate-400 font-medium">Integrated Tech Stack</p>
              </div>
            </div>

            {/* Bottom-Left Floating Badge */}
            <div className="absolute -bottom-2 -left-2 sm:-left-4 flex items-center gap-3.5 px-4 py-2.5 rounded-2xl bg-white/95 dark:bg-slate-950/95 border border-slate-200/90 dark:border-slate-800/90 shadow-2xl shadow-blue-500/10 dark:shadow-black/60 backdrop-blur-xl">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 text-white flex items-center justify-center font-black text-xs shadow-md shadow-blue-500/30">
                <ShieldCheck className="w-5 h-5 text-white" />
              </div>
              <div>
                <p className="text-[0.73rem] font-bold text-slate-800 dark:text-slate-200 leading-none">100% Client Satisfaction</p>
                <p className="text-[0.65rem] text-slate-400 mt-0.5">High Performance Apps</p>
              </div>
            </div>
