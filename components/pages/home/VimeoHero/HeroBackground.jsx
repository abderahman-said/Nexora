    ...
    return (
        <>
            ...
            >
                ...
                <div className="hero-side-el flex items-center justify-center opacity-50 font-['Epilogue',sans-serif] text-[0.85rem] font-bold text-slate-700 dark:text-slate-300">
                    WEB
                </div>
            </div>
            ...
            <div aria-hidden="true" className="absolute inset-0 opacity-25 pointer-events-none">
                <Particles
                    particleColors={['#3b82f6', '#38bdf8', '#60a5fa', '#818cf8', '#93c5fd']}
                    particleCount={130}
                    speed={0.3}
