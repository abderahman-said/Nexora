  ...
  return (
    ...
    >
      ...
      <div className="relative w-full rounded-2xl overflow-hidden aspect-[4/3] mb-5 bg-slate-100 dark:bg-slate-900 group/img">
        ...
        {/* Founder Crown Badge */}
        {isFounder && (
          <div className="absolute top-3 left-3 bg-gradient-to-r from-amber-500 to-yellow-500 text-white px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-lg shadow-amber-500/40 z-10 border border-white/20 backdrop-blur-sm">
