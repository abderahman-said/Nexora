...
/**
 * 💡 Reusable Form Input Component Pattern
 * Encapsulates label, leading icon, input/textarea element, and validation message.
 * Flexibly accepts standard HTML input attributes via `...props`.
 *
 * Example Usage:
 * <FormInput
 *   label="Full Name"
