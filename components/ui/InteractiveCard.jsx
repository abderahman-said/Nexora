    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex items-center justify-between mb-6">
                ...
                {serial && (
                    <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/80 border border-blue-200/80 dark:border-blue-800/60 text-blue-600 dark:text-sky-400 font-extrabold text-[0.7rem] font-mono tracking-widest uppercase shadow-sm">
            ...
            {/* ── Content Body (Stretches to fill available space so bottom buttons align) ── */}
            <div className="flex-1 flex flex-col justify-between">
                ...
                {features.length > 0 && (
                    <div className="relative flex flex-wrap gap-2 justify-center z-10 mb-6 pt-4 border-t border-slate-100 dark:border-slate-800/80">
