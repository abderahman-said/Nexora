...
const CircularText = ({ text, spinDuration = 20, onHover = 'speedUp', className = '' }) => {
  ...
  return (
    <motion.div
      className={`mx-auto rounded-full w-[200px] h-[200px] max-md:w-[120px] max-md:h-[120px] relative font-[900] text-white text-center cursor-pointer origin-center will-change-transform [contain:layout_style_paint] ${className}`}
